...
void solve() {
    vpi p(3); re(p[0],p[1],p[2]);
    if(p[0].ff==p[1].ff&&p[0].ff==p[2].ff&&(p[2].ss>=min(p[0].ss,p[1].ss)&&p[2].ss<=max(p[0].ss,p[1].ss))){
        cout<<abs(p[0].ff-p[1].ff)+abs(p[0].ss-p[1].ss)+2<<nl;return;
    }else if(p[0].ss==p[1].ss&&p[0].ss==p[2].ss&&(p[2].ff>=min(p[0].ff,p[1].ff)&&p[2].ff<=max(p[0].ff,p[1].ff))){
        cout<<abs(p[0].ff-p[1].ff)+abs(p[0].ss-p[1].ss)+2<<nl;return;
    }else{
        cout<<abs(p[0].ff-p[1].ff)+abs(p[0].ss-p[1].ss)<<nl;return;}
}

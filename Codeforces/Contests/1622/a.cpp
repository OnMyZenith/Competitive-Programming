...
void solve() {
    rv(3,a); sor(a); if(a[2]==a[0]+a[1]){ps("YES");return;}
    if(a[0]==a[1]&&a[2]>1&&a[2]%2==0){ps("YES");return;}
    if(a[2]==a[1]&&a[0]>1&&a[0]%2==0){ps("YES");return;}
    if(a[0]==a[2]&&a[1]>1&&a[1]%2==0){ps("YES");return;}
    ps("NO");

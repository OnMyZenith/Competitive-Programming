...
void solve() {
    ...
    // if((!(2LL*b-c)&&!a)&&sames(2LL*b-c,a)&&((2LL*b-c)/a)*a==(2LL*b-c)) f =1;
    // if((!(2LL*b-a)&&!c)&&sames((2LL*b-a),c)&&((2LL*b-a)/c)*c==(2LL*b-a)) f =1;
    // if((!(a+c)&&!b)&&sames(b,a+c)&&((a+c)/(2LL*b))*(2LL*b)==(a+c)) f =1;
    if(f){
        ps("YES");
    }
    else ps("NO");
